...
import resultSt from '../__fixtures__/result';
...
describe('gendiff', () => {
  test.each(testList)('gendiff %s', (format) => {
    ...
    expect(gendiff(filepath1, filepath2)).toEqual(resultSt);
    expect(gendiff(filepath1, filepath2, 'stylish')).toEqual(resultSt);
